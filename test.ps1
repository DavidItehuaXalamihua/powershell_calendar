function cal {
    ...
    if (($month -gt 12 -or $month -lt 1) -or ($year -gt 9999 -or $year -lt 1)){
        Write-Host "⚠️ Los valores permitidos son:" -ForegroundColor Yellow 
        Write-Host "-month: del 1 al 12" -ForegroundColor Yellow
        Write-Host "-year: del 1 al 9999" -ForegroundColor Yellow
        return
    }
